...
var ASM_CONSTS = {
  4597216: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4597277: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4597341: function() {return Module.webglContextAttributes.powerPreference;},  
 4597399: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4597454: function($0) {performance.now = function() { return $0; };},  
 4597502: function($0) {performance.now = function() { return $0; };},  
 4597550: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _connectSocket(url) {
          // Ensure that Socket.IO client is included in the HTML
          /*
          if (!window.io) {
          ...
          socket.on('serverEvent', function(data) {
              ...
              // Notify Unity about the received message
              SendMessage('GameObjectName', 'OnMessageReceived', data);
          });*/
  
          var a = UTF8ToString(url);
              console.log("url : " + a);
  ...
  function _emitData(eventName, data) {
          if (window.socket) {
              window.socket.emit(UTF8ToString(eventName), UTF8ToString(data), function(response) {
                  console.log('Response from server:', response);
              });
          } else {
              console.error('Socket not initialized');
          }
              console.log("event : " + UTF8ToString(eventName));
              console.log("data : " + UTF8ToString(data));
      }
