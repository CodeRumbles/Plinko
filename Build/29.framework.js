...
var ASM_CONSTS = {
  4591920: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4591981: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4592045: function() {return Module.webglContextAttributes.powerPreference;},  
 4592103: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4592158: function($0) {performance.now = function() { return $0; };},  
 4592206: function($0) {performance.now = function() { return $0; };},  
 4592254: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _connectSocket(url) {
          ...
          window.socket = socket; // Store the socket instance in the global window object
      }

  function _emitData(eventName, data) {
          if (window.socket) {
              window.socket.emit(eventName, JSON.parse(UTF8ToString(data)));
          } else {
